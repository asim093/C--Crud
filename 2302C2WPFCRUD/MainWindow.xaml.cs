...
namespace _2302C2WPFCRUD
{
    ...
    public partial class MainWindow : Window
    {
        ...
        SqlConnection Conn = new SqlConnection("Data Source=DESKTOP-BFAJCOL\\SQLEXPRESS;Initial Catalog=CRUD;User ID=asimusman;Password=asimusman8899;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
        ...
        private void UpdateProduct(object sender, RoutedEventArgs e)
        {
            if (isValid())
            {
                SqlCommand updProd = new SqlCommand("Update products set pname=@pname, description=@desc, price=@price,qty=@qty, cat=@cat Where Id=@pid;", Conn);
